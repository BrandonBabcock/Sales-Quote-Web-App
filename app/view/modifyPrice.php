        ...
        <div class="panel-body">
            <form name="modifyPricingForm" method="post" action="modifyPricing.php">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="currentServicesHourlyRate" ng-disabled="true"  ng-model="currentServicesHourlyRate" ng-value="' . $servicesHourlyRate . '" id="currentServicesHourlyRate">
