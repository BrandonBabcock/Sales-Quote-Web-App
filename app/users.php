    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <div class="form-group">
                <label>SEARCH</label>
                <input type="text" class="form-control" name="search" ng-model="search" id="search" placeholder="search">
                <br/>
                <div> <a ng-model="addUser" ui-sref="addUser" class="btn btn-primary" style="width:50%!important;height: 45px!important;">SEARCH<span class="glyphicon glyphicon-circle-arrow-right"></span></a></div>
